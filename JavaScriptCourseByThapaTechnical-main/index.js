...
// Naming Practice
//only $ and _ can be used and can be used anywhere
//number at start of var name not allowed
// var _myName = "vinod";
// console.log(_myName)
...
// console.log(!((a>0) || (b<0)));  //true or true
// console.log(!true);
...
// var sum=0
// for(var i=0;i<10;i++){  //0,1,2,3,4,5
//   sum=sum+i;  //sum=0,1,3,6,10,15
//   if(sum>10){
//     break;
//   }
// }
// console.log(`loop break at i=${i}`)//5
// console.log(sum)//15
...
// ➡ we can now use Dynamic Properties 
  ...
  // let yName = "vinod thapa";
  // let yAge = 26;

  // const yBio = {yName,yAge}
...
// let myname="my name is vinod".padStart(5);
// console.log(myname)
...
// }
                              ...
                              // 3 types of fat arrow function
// const sum=()=>{
//   return `sum of two nos is ${(7+1)}`
// }
// console.log(sum());
...
// // last ocurrence of searchValue, or -1 if not found.

//If you pass the fromIndex argument to the string, the lastIndexOf() method 
//will start searching backward from the fromIndex as shown in the following example:
